        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav nav-justified main-menu">
                    ...
                    <li class="nav-user dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Ventilatori <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <!-- Content container to add padding -->
                                <div class="yamm-content">
                                    <div class="row">
                                        <ul class="col-sm-6 col-lg-4 col-same-height list-unstyled">
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Ventilatori a soffitto con luce</strong></h4></a>
                                                <ul class="list-unstyled lampadari">
                                            ...
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Ventilatori senza luce</strong></h4></a>
                                                <ul class="list-unstyled">
                    ...
                    <li class="nav-user dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Lampadine <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <!-- Content container to add padding -->
                                <div class="yamm-content">
                                    <div class="row">
                                        <ul class="col-sm-6 col-lg-4 col-same-height list-unstyled">
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Lampadine LED e alogene</strong></h4></a>
                                                <ul class="list-unstyled plafoniere">
                                            ...
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Componenti illuminazione</strong></h4></a>
                                                <ul class="list-unstyled">
                    ...
                    <li class="nav-user dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Stili <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <!-- Content container to add padding -->
                                <div class="yamm-content">
                                    <div class="row">
                                        <ul class="col-sm-6 col-lg-4 col-same-height list-unstyled">
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Scegli lo stile delle lampade</strong></h4></a>
                                                <ul class="list-unstyled">
                    ...
                    <li class="nav-user dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Ambienti <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <!-- Content container to add padding -->
                                <div class="yamm-content">
                                    <div class="row">
                                        <ul class="col-sm-6 col-lg-4 col-same-height list-unstyled">
                                            <li class="subcategory">
                                                <a href="#"><h4><strong>Scegli l'ambiente dove vuoi mettere le lampade</strong></h4></a>
                                                <ul class="list-unstyled">
